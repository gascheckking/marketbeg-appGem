...
export default function KarmaSellerDashboard() {
  ...
  return (
    <div className="page-wrapper" style={{ padding: '10px 15px' }}>
      ...
      <div className="glass-card" style={{ marginTop: '20px', border: '1px solid rgba(0, 255, 136, 0.2)', padding: '12px' }}>
        <div style={{ fontSize: '8px', fontWeight: 900, color: 'var(--neon-mint)', marginBottom: '4px' }}>MARKET PULSE</div>
        <p style={{ fontSize: '10px', fontWeight: 600, margin: 0 }}>Vinterjackor säljer 40% snabbare just nu.</p>
      </div>
    </div>
  );
}
